...
test_film_data_dict_for_index = [
  {
    ...
    "actors": [test_person_data_dict_for_index[0], ],
    "writers": [],
    "directors": []
  },
  {
    ...
    "actors": [test_person_data_dict_for_index[0], ],
    "writers": [test_person_data_dict_for_index[1], ],
    "directors": []
  },
  {
    ...
    "imdb_rating": 9.5,
    "description": "todo: add faker data",
    "genres": [test_genres_data_dict[-1], ],
    "actors": [test_person_data_dict_for_index[2], ],
    "writers": [test_person_data_dict_for_index[2], ],
    "directors": [test_person_data_dict_for_index[2], ]
  },
]

test_shortfilm_data_dict = [
  FilmShort(**item)
  for item in test_film_data_dict_for_index
]
